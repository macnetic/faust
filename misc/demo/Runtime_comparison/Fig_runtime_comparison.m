...
load(matfile);
[RCGS,DIMS,NB_FACTS,constraint,Nb_mult,constraint,vector_or_matrix]=deal(params.RCGs,params.Dims,params.nb_facts,params.constraint,params.Nb_mult,params.constraint,params.matrix_or_vector);
