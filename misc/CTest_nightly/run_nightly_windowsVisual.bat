...
REM # CTEST OPTION 
set CTEST_CONFIGURE_OPTIONS=-DBUILD_OPENBLAS=OFF; -DBUILD_READ_MAT_FILE=OFF; -DBUILD_READ_XML_FILE=OFF; -DBUILD_WRAPPER_MATLAB=ON; -DBUILD_USE_GPU:BOOL=OFF; -DBUILD_USE_PROFILING=OFF; -DBUILD_VERBOSE=OFF; -DBUILD_DOCUMENTATION:BOOL=OFF;
