...
template<typename faust_real>
faust_real faust_cu_sum(const faust_real* data, const int nb_el);

template<typename faust_real>
faust_real faust_cu_max(const faust_real* data, const int nb_el);

template<typename faust_real>
faust_real faust_cu_min(const faust_real* data, const int nb_el);

template<typename faust_real>
faust_real faust_cu_norm(const faust_real* data, const int nb_el);
