...
bool testMEG  = true;
  ...
  faust_params params;
  if (testMEG)
     init_params_from_matiofile(params, "../data/config_MEG.mat", "params");
  else
     init_params_from_matiofile(params, "../data/config_compared_hierarchical_fact.mat", "params");
...
//cout << "update_way=" << params.isUpdateWayR2L << endl;
  ...
  {
     if (testMEG)
        sprintf(filename, "../data/facts_MEG%d.txt", i);
     else
        sprintf(filename, "../data/learning_compared_fact%d.txt", i);
  ...
  if (testMEG)
  {
     vec_out_faust.print_file("../output/vec_out_MEG_faust.dat");
     vec_out_mat.print_file("../output/vec_out_MEG_mat.dat");
  }
  else
  {
     vec_out_faust.print_file("../output/vec_out_hier_fact_faust.dat");
     vec_out_mat.print_file("../output/vec_out_hier_fact_mat.dat");
  }
