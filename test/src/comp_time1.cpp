...
\param inputfile Faust_example.mat where all the Fausts with different Density, Dimensions and number of factor are stored. This file is generated by test/gen_artificial_faust.m 
\param NB_run the number of test

The different computed times are stored in 2 different files :
\output temps_faust.dat 
\output temps_dense.dat
