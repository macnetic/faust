...
ELSE(WIN32)
	...
	SET (CTEST_SOURCE_DIRECTORY "$ENV{HOME}/faust_test-ci")
	SET (CTEST_BINARY_DIRECTORY "$ENV{HOME}/faust_test_build-ci")
	SET (CTEST_INSTALL_DIR      "$ENV{HOME}/faust_output-ci")
ENDIF(WIN32)
