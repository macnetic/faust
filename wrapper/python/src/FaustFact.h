...
FaustCoreCpp<FPP>* palm4msa2020(FPP* mat, unsigned int num_rows, unsigned int num_cols,  PyxConstraintGeneric** constraints, unsigned int num_cons, FPP2* out_buf, PyxStoppingCriterion<FPP2> sc, bool is_update_way_R2L, int factor_format, bool packing_RL, bool no_normalization, PyxMHTPParams<FPP2> &MHTP_params, unsigned int norm2_max_iter, FPP2 norm2_threshold, bool is_verbose, bool constant_step_size, FPP2 step_size, bool full_gpu=false, FaustCoreCpp<FPP>* th=nullptr);

template<typename FPP, FDevice DEV, typename FPP2 = Real<FPP>>
TransformHelper<FPP, DEV>* palm4msa2020_gen(FPP* mat, unsigned int num_rows, unsigned int num_cols,  PyxConstraintGeneric** constraints, unsigned int num_cons, FPP2* out_buf, PyxStoppingCriterion<FPP2> sc, bool is_update_way_R2L, int factor_format, bool packing_RL, bool no_normalization, PyxMHTPParams<FPP2> &MHTP_params, unsigned int norm2_max_iter, FPP2 norm2_threshold, bool is_verbose, bool constant_step_size, FPP2 step_size, FaustCoreCpp<FPP>* th=nullptr);
