...
classdef ParamsHierarchical < matfaust.factparams.ParamsFact
	...
	methods
		...
		function mex_params = to_mex_struct(this, M)
			...
			% order of struct fields doesn't matter
			mex_params = struct('nfacts', this.num_facts, ...
				'cons', {mex_constraints}, ...
				'niter1', this.stop_crits{1}.num_its,'niter2', this.stop_crits{2}.num_its, ...
				'sc_is_criterion_error', this.stop_crits{1}.is_criterion_error, ...
				'sc_error_treshold', this.stop_crits{1}.tol, ...
				'sc_max_num_its', this.stop_crits{1}.maxiter, ...
				'sc_erreps', this.stop_crits{1}.erreps, ...
				'sc_is_criterion_error2', this.stop_crits{2}.is_criterion_error, ...
				'sc_error_treshold2', this.stop_crits{2}.tol, ...
				'sc_max_num_its2', this.stop_crits{2}.maxiter, ...
				'sc_erreps2', this.stop_crits{2}.erreps, ...
				'nrow', this.data_num_rows, ...
				'ncol', this.data_num_cols, ...
				'fact_side', this.is_fact_side_left, ...
				'update_way', this.is_update_way_R2L, ...
				'verbose', this.is_verbose, ...
				'init_lambda', this.init_lambda, ...
				'factor_format', matfaust.factparams.ParamsFact.factor_format_str2int(this.factor_format), ...
				'packing_RL', this.packing_RL, ...
				'no_normalization', this.no_normalization, ...
				'no_lambda', this.no_lambda, ...
				'norm2_threshold', this.norm2_threshold, ...
				'norm2_max_iter', this.norm2_max_iter, ...
				'step_size', this.step_size, ...
				'constant_step_size', this.constant_step_size, ...
				'grad_calc_opt_mode', this.grad_calc_opt_mode);
