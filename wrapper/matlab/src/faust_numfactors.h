...
/*  apnumfactorsimations of matrices and applications", Journal of Selected       */
/*  Topics in Signal Processing, 2016.                                      */
/*  <https://hal.archives-ouvertes.fr/hal-01167948v1>                       */
#ifndef __MEX_FAUST_NUMFACTORS__
#define __MEX_FAUST_NUMFACTORS__
template <typename SCALAR, FDevice DEV>
void faust_numfactors(const mxArray **prhs, const int nrhs, mxArray **plhs, const int nlhs);
#include "faust_numfactors.hpp"
#endif
