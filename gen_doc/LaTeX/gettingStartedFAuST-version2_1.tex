...
\def \FAuST {FA$\mu$ST}
\title{Getting Started with the FA$\mu$ST Toolbox version 2.1 \textbf{[DEPRECATED
Guide, please rely on faust.inria.fr and https://gitlab.inria.fr/faustgrp/faust for FAµST v3.x.x+]}\smallbreak "Flexible Approximate Multi-Layer Sparse Transforms " \bigbreak
\bigbreak
