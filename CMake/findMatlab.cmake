...
elseif(WIN32)
	...
	message(STATUS "please add environment variable MATLAB_EXE_DIR ")
	...
	#set(findMatlabRootBAT "${CMAKE_SOURCE_DIR}/CMake/find_matlab_root_V2.bat" CACHE STRING "fichier bat matlab " FORCE )
	#exec_program(${findMatlabRootBAT})
	#message(STATUS "MATLAB_DIR_TMP 2 = ${MATLAB_DIR_TMP}")
...
if( ${MATLAB_DIR_TMP} MATCHES "matlab")
	if(UNIX)
		...
		if( ${MATLAB_ROOT} MATCHES "matlab") # Dans ce cas, le remplacment ne s'est pas fait.. on essaie avec la double separation "//"
			...
			message(STATUS "MATLAB_ROOT TMP3: ${MATLAB_ROOT}")
		endif()
