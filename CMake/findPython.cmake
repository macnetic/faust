...
if(UNIX OR WIN32)
	...
	message(STATUS "INFO- If you want to choose another version of Python,")
	...
	if("$ENV{PYTHON2_PATH}" MATCHES python OR "$ENV{PYTHON3_PATH}" MATCHES python)
		message(STATUS "Using PYTHON2/3_PATH env. variable.")
	...
	elseif ("$ENV{PYTHON_PATH}" MATCHES python)
		message(STATUS "Using PYTHON_PATH env. variable.")
	...
	elseif (${PYTHON_PATH} MATCHES python)
		message(STATUS "Using PYTHON_PATH cmake variable.")
		...
		message(STATUS "Environment variables/option PYTHON*_PATH not used, using find_package...")
