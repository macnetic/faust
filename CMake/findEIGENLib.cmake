...
if (EIGEN_INC_DIR)
	...
	if(UNIX)
		...
		add_include_path(INCLUDE_PATH_LIST_TMP2 "${PROJECT_SOURCE_DIR}/externals/unix/eigen")
	elseif(WIN32)
		...
		add_include_path(INCLUDE_PATH_LIST_TMP2 "${PROJECT_SOURCE_DIR}/externals/win/eigen")
	else(UNIX)
