...
if (EIGEN_INC_DIR)
	...
	if(UNIX)
		...
		add_include_path(INCLUDE_PATH_LIST_TMP2 "$ENV{CUDADIR}" "$ENV{MATIODIR}" "$ENV{MATIODIRINC}" "/usr" "/usr/local" "/usr/include/libxml2" "/opt"  "/opt/local" "${PROJECT_SOURCE_DIR}/externals/unix/eigen")
	elseif(WIN32)
		...
		add_include_path(INCLUDE_PATH_LIST_TMP2 "$ENV{CUDADIR}" "$ENV{MATIODIR}" "$ENV{MATIODIRINC}" "/usr" "/usr/local" "/usr/include/libxml2" "/opt"  "/opt/local" "${PROJECT_SOURCE_DIR}/externals/win/eigen")
	else(UNIX)
	...
	set(INCLUDE_PATH_LIST ${INCLUDE_PATH_LIST_TMP2} CACHE PATH "List of include paths used as PATH parameter in find_path")
