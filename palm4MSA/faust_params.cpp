...
faust_params::faust_params() : data(0,0),nb_fact(0),cons(),isFactSideLeft(false),isVerbose(false),isUpdateWayR2L(false),init_fact(),init_lambda(1),nb_rows(0),nb_cols(0) 
{}
