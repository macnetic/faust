...
template<typename T> class faust_constraint_int;
...
struct constraint_type
{
	...
	typedef const  faust_constraint_int<T>   constraint_type_sp;
	typedef const  faust_constraint_int<T>   constraint_type_spcol;
	typedef const  faust_constraint_int<T>   constraint_type_splin;
	typedef const  faust_constraint_int<T>   constraint_type_splincol;
	typedef const  faust_constraint_int<T>   constraint_type_sp_pos;
	typedef const  faust_constraint_int<T>   constraint_type_blkdiag;
