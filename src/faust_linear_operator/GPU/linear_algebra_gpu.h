...
//! \fn void gemv(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::Vect<FPP,Gpu>& cu_x, Faust::Vect<FPP,Gpu>& cu_y, const FPP alpha, const FPP beta, char typeA, BlasHandle<Gpu> blasHandle);
...
//! \fn void gemv(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::Vect<FPP,Gpu>& cu_x, Faust::Vect<FPP,Gpu>& cu_y, char typeA, BlasHandle<Gpu> blasHandle);
//! y = op(A) * x
template <typename FPP>
...
//! \fn void gemv(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::Vect<FPP,Gpu>& cu_x, Faust::Vect<FPP,Gpu>& cu_y, BlasHandle<Gpu> blasHandle);
//! Performs - y = A * x
template <typename FPP>
...
//! \fn void multiply(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::Vect<FPP,Gpu>& cu_x, Faust::Vect<FPP,Gpu>& cu_y, BlasHandle<Gpu> blasHandle);
//! Performs y = A * x
template <typename FPP>
...
//! \fn void gemm(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::MatDense<FPP,Gpu>& cu_B, Faust::MatDense<FPP,Gpu>& cu_C,const FPP alpha, const FPP beta, char  typeA, char  typeB, BlasHandle<Gpu> blasHandle);
...
//! \fn void gemm(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::MatDense<FPP,Gpu>& cu_B, Faust::MatDense<FPP,Gpu>& cu_C, char typeA, char typeB, BlasHandle<Gpu> blasHandle);
...
//! \fn void gemm(const Faust::MatDense<FPP,Gpu>& cu_A, const Faust::MatDense<FPP,Gpu>& cu_B, Faust::MatDense<FPP,Gpu>& cu_C, BlasHandle<Gpu> blasHandle);
//! Performs C = A * B
template <typename FPP>
...
//! Performs y = A * x
template <typename FPP>
void multiply(const Faust::MatSparse<FPP,Gpu>& cu_A, const Faust::Vect<FPP,Gpu>& cu_x, Faust::Vect<FPP,Gpu>& cu_y, BlasHandle<Gpu> blasHandle, SpBlasHandle<Gpu> spblasHandle);
